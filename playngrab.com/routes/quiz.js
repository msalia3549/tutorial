...
router.post('/quiz_data_api', function(req, res) {
...
//  var quiz_query = data.query('SELECT * FROM players WHERE alias = ?', login_query_alias,function(err, rows) {
